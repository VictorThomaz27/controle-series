<x-layoutSys title="Nova Empresa">
    <div class="row w-100 justify-content-center">
        <div class="col-12 col-lg-8">
            <div class="card shadow-sm">
                <div class="card-header bg-dark text-white">Cadastro de Empresa</div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form method="post" action="/empresas/salvar">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-8">
...
(function(){
  ...
  function fillFromGeocode(data){
    ...
    if(cityInput && !cityInput.value){ cityInput.value = addr.city || addr.town || addr.village || ''; }
    const stateInput = document.getElementById('state');
    if(stateInput && !stateInput.value){ stateInput.value = addr.state_code || addr.state || ''; }
    const zipInput = document.getElementById('zip_code');
    if(zipInput && !zipInput.value){ zipInput.value = addr.postcode || ''; }
  }
