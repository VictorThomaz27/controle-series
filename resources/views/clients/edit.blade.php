<x-layoutSys title="Editar Cliente">
    <div class="row w-100 justify-content-center">
        <div class="col-12 col-lg-8">
            <div class="card shadow-sm">
                <div class="card-header bg-dark text-white">Edição de Cliente</div>
                <div class="card-body">
                    @if ($errors->any())
                        ...
                        <div class="row g-3">
                            <div class="col-md-8">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="full_name" name="full_name" placeholder="Nome completo" value="{{ old('full_name', $client->full_name) }}" required>
                                    <label for="full_name">Nome completo</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="cpf" name="cpf" placeholder="CPF" value="{{ old('cpf', $client->cpf) }}" required>
                            ...
                            <div class="col-md-8">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="address_line" name="address_line" placeholder="Endereço" value="{{ old('address_line', $client->address_line) }}">
                                    <label for="address_line">Endereço</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="address_number" name="address_number" placeholder="Número" value="{{ old('address_number', $client->address_number) }}">
                                    <label for="address_number">Número</label>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="city" name="city" placeholder="Cidade" value="{{ old('city', $client->city) }}">
                                    <label for="city">Cidade</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="state" name="state" placeholder="UF" value="{{ old('state', $client->state) }}">
                                    <label for="state">UF</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="zip_code" name="zip_code" placeholder="CEP" value="{{ old('zip_code', $client->zip_code) }}">
                            ...
                            <div class="col-md-8 d-flex align-items-center">
                                <div class="btn-group mt-3 mt-md-0" role="group">
                                    ...
                                    <button type="button" class="btn btn-outline-primary" id="btnUseInRouting" {{ ($client->lat && $client->lon) ? '' : 'disabled' }}>Usar no cálculo</button>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="number" step="0.000001" class="form-control" id="lat" name="lat" placeholder="Latitude" value="{{ old('lat', $client->lat) }}">
                                    <label for="lat">Latitude</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="number" step="0.000001" class="form-control" id="lon" name="lon" placeholder="Longitude" value="{{ old('lon', $client->lon) }}">
...
(function(){
    ...
    function fillFromGeocode(data){
        ...
        if(stateInput && !stateInput.value){
            stateInput.value = addr.state_code || addr.state || stateInput.value || '';
        }
        const zipInput = document.getElementById('zip_code');
        if(zipInput && !zipInput.value){
            zipInput.value = addr.postcode || zipInput.value || '';
        }
